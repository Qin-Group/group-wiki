...
# Conference
The following conferences are major venues for presenting research in computational neuroscience.

- **COSYNE (Computational and Systems Neuroscience)**  
  Website: [https://cosyne.org/](https://cosyne.org/)  
  Description: An annual conference that focuses on the intersection of computational and systems neuroscience.
...
- **CNS (Computational Neuroscience Meeting)**  
  Website: [https://www.cnsorg.org/](https://www.cnsorg.org/)  
  Description: A biennial meeting that brings together researchers in computational neuroscience.
- **SfN (Society for Neuroscience Annual Meeting)**  
  Website: [https://www.sfn.org/](https://www.sfn.org/)  
  Description: The largest neuroscience conference, covering all areas of neuroscience including computational approaches.
- **ICML (International Conference on Machine Learning)**  
  Website: [https://icml.cc/](https://icml.cc/)  
  Description: A premier conference in machine learning that often features research relevant to computational neuroscience.
- **ICLR (International Conference on Learning Representations)**  
  Website: [https://iclr.cc/](https://iclr.cc/)  
  Description: A conference focused on deep learning and representation learning, with applications in neuroscience.
